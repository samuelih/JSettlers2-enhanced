---
id: INV-CL-010
name: single-writer-panref-current
type: INVARIANT
status: candidate
...
defined-in: invariants/INV-CL-010.invariant.md
references:
...
# [INV-CL-010] single-writer: field `panRef.current` is mutated by exactly one function (`MapEditorScreen`)

> _Detected by ; HYPOTHESIS candidate invariant pending human ratification._

## Guarantee
single-writer: field `panRef.current` is mutated by exactly one function (`MapEditorScreen`)
...
## Cited By Code
- [web/src/screens/MapEditorScreen.tsx:264](../../../web/src/screens/MapEditorScreen.tsx#L264) — `panRef.current = ...`
- [web/src/screens/MapEditorScreen.tsx:283](../../../web/src/screens/MapEditorScreen.tsx#L283) — `panRef.current = ...`

## Forbidden Bypasses
- Direct writes to `panRef.current` outside the cited writer function.
