---
id: INV-CL-007
name: single-writer-prevmyturn-current
type: INVARIANT
status: candidate
...
defined-in: invariants/INV-CL-007.invariant.md
references:
...
# [INV-CL-007] single-writer: field `prevMyTurn.current` is mutated by exactly one function (`useGameFeedback`)

> _Detected by ; HYPOTHESIS candidate invariant pending human ratification._

## Guarantee
single-writer: field `prevMyTurn.current` is mutated by exactly one function (`useGameFeedback`)
...
## Cited By Code
- [web/src/screens/GameScreen.tsx:872](../../../web/src/screens/GameScreen.tsx#L872) — `prevMyTurn.current = ...`
- [web/src/screens/GameScreen.tsx:893](../../../web/src/screens/GameScreen.tsx#L893) — `prevMyTurn.current = ...`

## Forbidden Bypasses
- Direct writes to `prevMyTurn.current` outside the cited writer function.
