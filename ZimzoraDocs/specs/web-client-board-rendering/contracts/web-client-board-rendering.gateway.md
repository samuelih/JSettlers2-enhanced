---
id: web-client-board-rendering.gateway
type: GATEWAY
...
# Web Client & Board Rendering Gateway

> Capability Index — public-API contract for the `Web Client & Board Rendering` epic. Cross-scope callers depend on the symbols listed below.
