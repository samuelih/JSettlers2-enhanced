---
id: game-model-rules-engine.gateway
type: GATEWAY
...
# Game Model & Rules Engine Gateway

> Capability Index — public-API contract for the `Game Model & Rules Engine` epic. Cross-scope callers depend on the symbols listed below.
