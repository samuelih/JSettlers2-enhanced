...
# Robot / AI Players Gateway

> Capability Index — public-API contract for the `Robot / AI Players` epic. Cross-scope callers depend on the symbols listed below.
