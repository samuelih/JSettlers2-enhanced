---
id: INV-CL-005
name: single-writer-prevdicetotal-current
type: INVARIANT
status: candidate
...
defined-in: invariants/INV-CL-005.invariant.md
references:
...
# [INV-CL-005] single-writer: field `prevDiceTotal.current` is mutated by exactly one function (`useGameFeedback`)

> _Detected by ; HYPOTHESIS candidate invariant pending human ratification._

## Guarantee
single-writer: field `prevDiceTotal.current` is mutated by exactly one function (`useGameFeedback`)
...
## Cited By Code
- [web/src/screens/GameScreen.tsx:870](../../../web/src/screens/GameScreen.tsx#L870) — `prevDiceTotal.current = ...`
- [web/src/screens/GameScreen.tsx:881](../../../web/src/screens/GameScreen.tsx#L881) — `prevDiceTotal.current = ...`

## Forbidden Bypasses
- Direct writes to `prevDiceTotal.current` outside the cited writer function.
